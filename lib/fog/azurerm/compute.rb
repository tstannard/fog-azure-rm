    ...
    class AzureRM < Fog::Service
      ...
      class Real
        def initialize(options)
          ...
          @compute_mgmt_client = ::Azure::Compute::Mgmt::V2020_06_30::ComputeManagementClient.new(credentials, resource_manager_endpoint_url(options[:environment]))
          @compute_mgmt_client.subscription_id = options[:subscription_id]
          @compute_mgmt_client.add_user_agent_information(telemetry)
          @storage_mgmt_client = ::Azure::Storage::Mgmt::V2021_01_01::StorageManagementClient.new(credentials, resource_manager_endpoint_url(options[:environment]))
