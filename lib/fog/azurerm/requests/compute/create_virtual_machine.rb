    ...
    class AzureRM
      ...
      class Real
        def create_virtual_machine(vm_config, async = false)
          ...
          vm = Azure::Compute::Mgmt::V2020_06_30::Models::VirtualMachine.new
        ...
        def get_hardware_profile(vm_size)
          hw_profile = Azure::Compute::Mgmt::V2020_06_30::Models::HardwareProfile.new
        ...
        def get_os_profile(vm_config)
          ...
          os_profile = Azure::Compute::Mgmt::V2020_06_30::Models::OSProfile.new
        ...
        def get_windows_config(provision_vm_agent, enable_automatic_updates)
          windows_config = Azure::Compute::Mgmt::V2020_06_30::Models::WindowsConfiguration.new
        ...
        def get_linux_config(disable_password_auth, ssh_key_path, ssh_key_data)
          linux_config = Azure::Compute::Mgmt::V2020_06_30::Models::LinuxConfiguration.new
          linux_config.disable_password_authentication = disable_password_auth

          unless ssh_key_path.nil? || ssh_key_data.nil?
            ssh_config = Azure::Compute::Mgmt::V2020_06_30::Models::SshConfiguration.new
            ssh_public_key = Azure::Compute::Mgmt::V2020_06_30::Models::SshPublicKey.new
        ...
        def get_network_profile(network_interface_card_ids)
          ...
          network_interface_card_ids.each_with_index do |id, index|
            nic = Azure::Compute::Mgmt::V2020_06_30::Models::NetworkInterfaceReference.new
            nic.id = id
            nic.primary = index == PRIMARY_NIC_INDEX
            network_interface_cards << nic
          end

          network_profile = Azure::Compute::Mgmt::V2020_06_30::Models::NetworkProfile.new
        ...
        def get_unmanaged_vm_storage_profile(vm_config)
          ...
          storage_profile = Azure::Compute::Mgmt::V2020_06_30::Models::StorageProfile.new
          # Set OS disk VHD path
          os_disk = Azure::Compute::Mgmt::V2020_06_30::Models::OSDisk.new
          vhd = Azure::Compute::Mgmt::V2020_06_30::Models::VirtualHardDisk.new
          ...
          if vhd_path.nil? && image_ref.nil?
            ...
            img_vhd = Azure::Compute::Mgmt::V2020_06_30::Models::VirtualHardDisk.new
            ...
            storage_profile.image_reference = Azure::Compute::Mgmt::V2020_06_30::Models::ImageReference.new
        ...
        def get_managed_vm_storage_profile(vm_config)
          ...
          storage_profile = Azure::Compute::Mgmt::V2020_06_30::Models::StorageProfile.new
          os_disk = Azure::Compute::Mgmt::V2020_06_30::Models::OSDisk.new
          managed_disk = Azure::Compute::Mgmt::V2020_06_30::Models::ManagedDiskParameters.new
        ...
        def image_reference(publisher, offer, sku, version)
          image_reference = Azure::Compute::Mgmt::V2020_06_30::Models::ImageReference.new
        ...
        def configure_os_disk_object(os_disk, os_disk_name, os_disk_caching, os_disk_size, platform, vm_name)
          ...
          os_disk.create_option = Azure::Compute::Mgmt::V2020_06_30::Models::DiskCreateOptionTypes::FromImage
          os_disk.caching = unless os_disk_caching.nil?
                              case os_disk_caching
                              when 'None'
                                Azure::Compute::Mgmt::V2020_06_30::Models::CachingTypes::None
                              when 'ReadOnly'
                                Azure::Compute::Mgmt::V2020_06_30::Models::CachingTypes::ReadOnly
                              when 'ReadWrite'
                                Azure::Compute::Mgmt::V2020_06_30::Models::CachingTypes::ReadWrite
                              end
                            end
          os_disk
        end
      ...
      class Mock
        def create_virtual_machine(*)
          ...
          @compute_mgmt_client.deserialize(vm_mapper, vm)
        end
      end
    end
  end
