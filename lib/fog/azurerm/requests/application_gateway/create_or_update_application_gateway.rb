    ...
    class AzureRM
      ...
      class Real
        ...
        def define_application_gateway(gateway_params)
          application_gateway = Azure::Network::Mgmt::V2020_05_01::Models::ApplicationGateway.new
          ...
          gateway_sku = Azure::Network::Mgmt::V2020_05_01::Models::ApplicationGatewaySku.new
        ...
        def define_gateway_ip_configuration(gateway_ip_configurations)
          ...
          gateway_ip_configurations.each do |ip_configuration|
            configuration = Azure::Network::Mgmt::V2020_05_01::Models::ApplicationGatewayIPConfiguration.new
        ...
        def define_ssl_certificate(ssl_certificates)
          ...
          ssl_certificates.each do |ssl_certificate|
            certificate = Azure::Network::Mgmt::V2020_05_01::Models::ApplicationGatewaySslCertificate.new
        ...
        def define_frontend_ip_configurations(frontend_ip_configurations)
          ...
          frontend_ip_configurations.each do |fic|
            frontend_ip_configuration = Azure::Network::Mgmt::V2020_05_01::Models::ApplicationGatewayFrontendIPConfiguration.new
            ...
            unless fic[:public_ip_address_id].nil?
              pip = Azure::Network::Mgmt::V2020_05_01::Models::PublicIPAddress.new
        ...
        def define_frontend_ports(frontend_ports)
          ...
          frontend_ports.each do |port|
            frontend_port = Azure::Network::Mgmt::V2020_05_01::Models::ApplicationGatewayFrontendPort.new
        ...
        def define_probes(probes)
          ...
          probes.each do |probe|
            ag_probe = Azure::Network::Mgmt::V2020_05_01::Models::ApplicationGatewayProbe.new
        ...
        def define_backend_address_pools(backend_address_pools)
          ...
          backend_address_pools.each do |bap|
            backend_pool = Azure::Network::Mgmt::V2020_05_01::Models::ApplicationGatewayBackendAddressPool.new

            backend_addresses1 = bap[:ip_addresses]
            addresses = []
            backend_addresses1.each do |address|
              backend_add = Azure::Network::Mgmt::V2020_05_01::Models::ApplicationGatewayBackendAddress.new
        ...
        def define_backend_http_settings(backend_http_settings_list)
          ...
          backend_http_settings_list.each do |http_setting|
            backend_http_setting = Azure::Network::Mgmt::V2020_05_01::Models::ApplicationGatewayBackendHttpSettings.new
            ...
            if http_setting[:probe]
              probe = Azure::Network::Mgmt::V2020_05_01::Models::Probe.new
        ...
        def define_http_listeners(http_listeners)
          ...
          http_listeners.each do |listener|
            http_listener = Azure::Network::Mgmt::V2020_05_01::Models::ApplicationGatewayHttpListener.new
            ...
            if listener[:frontend_ip_config_id]
              frontend_ip = Azure::Network::Mgmt::V2020_05_01::Models::FrontendIPConfiguration.new
            ...
            if listener[:ssl_certificate_id]
              ssl_cert = Azure::Network::Mgmt::V2020_05_01::Models::ApplicationGatewaySslCertificate.new
        ...
        def define_url_path_maps(url_path_maps)
          ...
          url_path_maps.each do |map|
            url_path_map = Azure::Network::Mgmt::V2020_05_01::Models::ApplicationGatewayUrlPathMap.new

            if map[:default_backend_address_pool_id]
              default_backend_address_pool = Azure::Network::Mgmt::V2020_05_01::Models::BackendAddressPool.new
            ...
            if map[:default_backend_http_settings_id]
              default_backend_http_setting = Azure::Network::Mgmt::V2020_05_01::Models::ApplicationGatewayBackendHttpSettings.new
        ...
        def define_path_rules(path_rules)
          ...
          path_rules.each do |rule|
            path_rule = Azure::Network::Mgmt::V2020_05_01::Models::ApplicationGatewayPathRule.new
            if rule[:backend_address_pool_id]
              backend_address_pool = Azure::Network::Mgmt::V2020_05_01::Models::BackendAddressPool.new
        ...
        def define_request_routing_rules(request_routing_rules)
          ...
          request_routing_rules.each do |rule|
            request_routing_rule = Azure::Network::Mgmt::V2020_05_01::Models::ApplicationGatewayRequestRoutingRule.new
