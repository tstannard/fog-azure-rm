    ...
    class AzureRM
      ...
      class Real
        ...
        def get_network_gateway_object(virtual_network_params)
          network_gateway = Azure::Network::Mgmt::V2020_05_01::Models::VirtualNetworkGateway.new
        ...
        def get_virtual_network_gateway_sku(virtual_network_params)
          sku = Azure::Network::Mgmt::V2020_05_01::Models::VirtualNetworkGatewaySku.new
        ...
        def get_vpn_client_config(vpn_client_config)
          client_config = Azure::Network::Mgmt::V2020_05_01::Models::VpnClientConfiguration.new

          address_pool = Azure::Network::Mgmt::V2020_05_01::Models::AddressSpace.new
        ...
        def get_root_certificates(root_certificates)
          ...
          root_certificates.each do |root_cert|
            root_certificate = Azure::Network::Mgmt::V2020_05_01::Models::VpnClientRootCertificate.new
        ...
        def get_revoked_certificates(revoked_certificates)
          ...
          revoked_certificates.each do |revoked_cert|
            revoked_certificate = Azure::Network::Mgmt::V2020_05_01::Models::VpnClientRevokedCertificate.new
        ...
        def get_ip_configurations(ip_configurations)
          ...
          ip_configurations.each do |ip_config|
            ip_configuration = Azure::Network::Mgmt::V2020_05_01::Models::VirtualNetworkGatewayIPConfiguration.new
      ...
      class Mock
        def create_or_update_virtual_network_gateway(*)
          ...
          @network_client.deserialize(gateway_mapper, gateway)
        end
      end
    end
  end
