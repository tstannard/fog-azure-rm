    ...
    class AzureRM
      ...
      class Real
        ...
        def get_storage_account_params(sku_name, location, replication, encryption_enabled, tags)
          params = Azure::Storage::Mgmt::V2021_01_01::Models::StorageAccountCreateParameters.new
          sku = Azure::Storage::Mgmt::V2021_01_01::Models::Sku.new
          sku.name = "#{sku_name}_#{replication}"
          params.sku = sku
          params.kind = Azure::Storage::Mgmt::V2021_01_01::Models::Kind::Storage
          params.location = location
          unless encryption_enabled.nil?
            encryption = Azure::Storage::Mgmt::V2021_01_01::Models::Encryption.new
            encryption_services = Azure::Storage::Mgmt::V2021_01_01::Models::EncryptionServices.new
            encryption_service = Azure::Storage::Mgmt::V2021_01_01::Models::EncryptionService.new
